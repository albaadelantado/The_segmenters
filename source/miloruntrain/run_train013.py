...
transform = transforms_v2.Compose([transforms_v2.RandomHorizontalFlip(0.5), transforms_v2.RandomVerticalFlip(0.5)])#, transforms_v2.RandomAffine(degrees = 0, shear = 0, translate = [0.1,0.1], scale = [0.1,0.1])])
